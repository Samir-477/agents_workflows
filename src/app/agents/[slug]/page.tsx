...
import { QuestionDiscoveryAgentPage } from "@/components/question-discovery-agent-page";
...
export default async function AgentPage({ params }: { params: Promise<{ slug:string }> }) {
  ...
  if(!agent) notFound();
  if(slug==="question-discovery") return <QuestionDiscoveryAgentPage agent={agent}/>;
